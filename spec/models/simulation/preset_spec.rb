...
# Le mode rapide ne pose aucun chiffre à lui : les valeurs attendues ici sont celles que
# l'assistant proposerait page après page, et le test le vérifie sur un bien complet.
RSpec.describe Simulation::Preset do
  # 50 m² à 200 000 € : 16 612 € de notaire, donc 216 612 € à financer.
  ...
  # Un dixième de 216 612 € arrondi à la dizaine, et 194 952 € empruntés vingt ans à 3,6 %.
  ...
  # Le loyer est saisi charges comprises : aucune provision ne s'en détache.
