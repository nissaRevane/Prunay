...
ActiveRecord::Schema[8.0].define(version: 2025_01_01_000023) do
  ...
  create_table "simulations", force: :cascade do |t|
    ...
    t.decimal "property_growth_rate", precision: 5, scale: 2, default: "1.0", null: false
    t.decimal "inflation_rate", precision: 5, scale: 2, default: "2.0", null: false
    t.decimal "loan_guarantee_fees", precision: 12, scale: 2, default: "0.0", null: false
    t.decimal "loan_application_fees", precision: 12, scale: 2, default: "0.0", null: false
    t.decimal "monthly_charges", precision: 12, scale: 2, default: "0.0", null: false
    t.integer "marginal_tax_rate", default: 30, null: false
    t.boolean "early_repayment_fee", default: true, null: false
    t.decimal "accounting_fees", precision: 12, scale: 2, default: "0.0", null: false
    t.decimal "furniture", precision: 12, scale: 2, default: "0.0", null: false
    t.decimal "furniture_maintenance", precision: 12, scale: 2, default: "0.0", null: false
    t.decimal "purchase_discount", precision: 12, scale: 2, default: "0.0", null: false
